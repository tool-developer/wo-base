...
describe('@tool-developer request options merge', () => {
  ...
  it('request post success', async () => {
    ...
    wxr.interceptors.response.use(response => {
      ...
      expect(req.url).toEqual('http://httpbin.org/post?a=1&c=%7B%22d%22:%22%22,%22e%22:null%7D');
...
describe('@tool-developer request encode', () => {
  ...
  it('request dataRequestEncode false ', async () => {
    ...
    wxr.interceptors.response.use(response => {
      ...
      expect(config.url).toEqual('http://httpbin.org/get?a=1&c=[]{}');
      //
      return response;
    });
    //
  ...
  it('request dataRequestEncode encodeURIComponent ', async () => {
    ...
    wxr.interceptors.response.use(response => {
      ...
      expect(config.url).toEqual('http://httpbin.org/get?a=1&c=%5B%5D%7B%7D');
      //
      return response;
    });
    //
  ...
  it('request dataRequestEncode default rfc3986 ', async () => {
    ...
    wxr.interceptors.response.use(response => {
      ...
      expect(config.url).toEqual('http://httpbin.org/get?a=1&c=[]%7B%7D');
      //
      return response;
    });
    //
